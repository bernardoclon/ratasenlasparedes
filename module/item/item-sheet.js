...
export class ratasenlasparedesItemSheet extends ItemSheet {
  ...
  get template() {
    ...
    // Para items de tipo 'scar', usar el template de 'mean'
    if (this.item.type === 'scar') {
      return `${path}/mean-sheet.html`;
    }
  ...
  async getData() {
    ...
    if (this.item.type === "spell") {
      context.system.level = this.item.system.level;
      context.system.cost = this.item.system.cost;
    }
