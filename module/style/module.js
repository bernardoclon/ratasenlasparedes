...
const compendiumThemes = [
  {
    ...
    bannerImage: `modules/${MODULE_ID}/img/art/banner1.png`,
  },
  {
    dataPack: `${MODULE_ID}.ayudas`,
    colorText: "#ff5252",
    iconText: "fa-solid fa-dot-circle",
    bannerImage: `modules/${MODULE_ID}/img/art/banner2.jpg`,
  },
  {
    dataPack: `${MODULE_ID}.equipo`,
    colorText: "#ff5252",
    iconText: "fa-solid fa-gavel",
    bannerImage: `modules/${MODULE_ID}/img/art/banner3.jpg`,
  },
  {
    dataPack: `${MODULE_ID}.profesiones`,
    colorText: "#ff5252",
    iconText: "fa-solid fa-user-secret",
    bannerImage: `modules/${MODULE_ID}/img/art/banner4.jpg`,
  },
  {
    dataPack: `${MODULE_ID}.reputaciones`,
    colorText: "#ff5252",
    iconText: "fa-solid fa-user-secret",
    bannerImage: `modules/${MODULE_ID}/img/art/banner5.png`,
  },
  {
    dataPack: `${MODULE_ID}.hechizos`,
    colorText: "#ff5252",
    iconText: "fa-solid fa-user-secret",
    bannerImage: `modules/${MODULE_ID}/img/art/banner6.png`,
  },
  {
